# Source this file inside your compute allocation: source scripts/activate-muse.sh
export AGENT_ROOT="/data/${USER:?}/pinnacles-agents"
export PATH="$AGENT_ROOT/envs/muse-vllm/bin:$AGENT_ROOT/tools/opencode-v1.18.30:$PATH"
