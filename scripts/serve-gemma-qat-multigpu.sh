#!/usr/bin/env bash
# Foreground multi-GPU server for Gemma 4 31B IT QAT across dual GPUs (2x A100 or 2x L40S).
# Uses vLLM Tensor Parallelism (TP=2) to scale context to 131,072 tokens.
